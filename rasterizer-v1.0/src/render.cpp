...
void renderChunk(const Chunk& chunk, const Mat4& view, const Mat4& proj)
{
    ...
    // --- render precomputed triangles only ---
    for (const Triangle& tri : chunk.triangles)
    {
        Vec4 v0 = vp * Vec4{tri.v0.position.x, tri.v0.position.y, tri.v0.position.z, 1};
        Vec4 v1 = vp * Vec4{tri.v1.position.x, tri.v1.position.y, tri.v1.position.z, 1};
        Vec4 v2 = vp * Vec4{tri.v2.position.x, tri.v2.position.y, tri.v2.position.z, 1};
